...
searchButton.addEventListener('click', async function (){
    // Validasi Inputan/Film yg dicri apkh ada/tdk dlm API
    try{
...
function getMovies(movies){
    ...
    // Bila key atau penulisan alamat API SALAH
    .then(response => {
        if(!response.ok){
            // Lempar isi error-nya ke CATCH
    ...
    // Validasi apabila kosong INPUTAN 
    .then(response => {
